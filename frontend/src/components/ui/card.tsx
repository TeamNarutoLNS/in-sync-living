...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      // Center icon + title with slightly more spacing
      "flex flex-col items-center justify-center space-y-3 px-6 pt-6 text-center",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "text-sm text-gray-600 px-6 text-center pb-4",
      className
    )}
    {...props}
  />
